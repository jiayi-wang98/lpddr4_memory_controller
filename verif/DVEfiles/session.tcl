...
# DVE reload session
# Saved on Mon Jun 6 09:43:23 2022
# Designs open: 1
...
gui_sg_addsignal -group "$_session_group_1" { refresher_tb.clk refresher_tb.rst refresher_tb.cmd_ready refresher_tb.cmd_valid refresher_tb.ref_tRP_cfg refresher_tb.ref_tRFC_cfg refresher_tb.ref_tREFI_cfg refresher_tb.ref_POSTPONE_cfg refresher_tb.cmd_a refresher_tb.cmd_ba refresher_tb.cmd_last refresher_tb.cmd_cas refresher_tb.cmd_ras refresher_tb.cmd_we }
...
catch {gui_list_select -id ${Hier.1} {refresher_tb}}
...
gui_list_show_data -id ${Data.1} {refresher_tb}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {refresher_tb.ref_tRP_cfg }}
